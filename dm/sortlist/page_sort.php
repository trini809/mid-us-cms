...
$dbTable = $tbl;					// the database table
$idField = $tblkey;					// the numeric primary key
$displayField = 'name';				// the field whose text will be shown
$orderField = 'listorder';			// the field that will hold the sort order for the row
...
// list all entries
$sql = "SELECT $idField, $displayField, $orderField from $dbTable where $tblfield = '".$ipid."' order by $orderField";
...
<?
// get parent name
print '<p><span class="txt15">Page Sort</span></p>
...
<?php
// uncomment to debug
// echo $ipid."<br />".$tbl."<br />".$tblkey."<br />".$tblfield;
?>
<!-- base block begins -->
 </div>
    <div id="spacer">&nbsp;</div>
