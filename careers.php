...
<div id="wrapper">
  ...
  <div id="container">
    <div id="leftcolumn">&nbsp;
      <!-- <?php include ("inc/career_menu.inc.php"); ?> -->
    </div>
    <!-- start main content  -->
    <div id="content">
    <!-- page title  -->
    <div id="title">
        ...
        <?php 
			...
			$distitle = db_query("select name from ".$dbext."parent_menu where pid = '91113' limit 1") or db_die();
			$pgtitle = fetch_row($distitle);
			echo $pgtitle[0];
			}
		?>
    ...
    <!-- body copy  -->  
     <?php
        ...
        $sql = db_query ("select content from ".$dbext."content where link = '".$pageID."' limit 1") or db_die();
        	...
        	$sql = db_query ("select content from ".$dbext."content where pgid = '65133' limit 1") or db_die();
        	$row = fetch_row($sql);
        	echo stripslashes($row[0]);
        	}
        ?>
